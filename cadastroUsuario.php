...
try{
// insert query
$query = "INSERT INTO usuario SET nome_usuario=:nome_usuario, nome_completo=:nome_completo, telefone=:telefone, email=:email, endereco=:endereco, senha=:senha";
...
<table class='table table-hover table-responsive table-bordered'>
    ...
    <div class="loginbox" style="width: 1250px; height: 800px; margin-top: 225px;">
