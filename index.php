...
<h1 style="font-family: Montserrat; font-size: 40px;"> Registros de outros usuários</h1>
...
<a href='cadastroUsuario.php' class='btn btn-primary m-b-1em' style="width: 150px; height: 40px; font-size: 19px; background:#2EA638; border:#2EA638;  color: white; border-radius: 10px; "> Cadastro </a>
